"""
Card game made only with Tkinter in Python, by Debjit Chattopadhyay\nAritra Ghosh\nPurnava Roy July,2018;
"""
...
class Window(object):
    ...
    def knownBugs(self):
        ...
        text = Label(newWindow, text="""These are the known bugs:
                                ...
                                > If all the cards are played too fast the bot can't keep up and will not draw.""")
    ...
    def gameRulesScreen(self):
        ...
        self.rules = Label(self.frameRules,bd = 1, relief = SUNKEN,
                           ...
                           "\n which you can click with the left mouse button to play them on the field, the computer will also play "
